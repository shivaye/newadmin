...
if($title=="")
{
    ...
    if($hid_id==false)
    {
      ...
      $select_category=exeQuery("select * from ".TABLE_PACKAGE." where title='".$title."' and status=1 ");
      $res_category=fetchAssoc($select_category);

      if($res_category['title']==$title)
      {
         $_SESSION['msg']="Package is already exists";
     }else{

      $insert=exeQuery("insert into ".TABLE_PACKAGE." set slug_name='".$slug."',price='".$price."',location='".$location."',description='".$description."',title='".$title."',status='".$status."',date='".$date."' $set ");


      if($insert)
      {
         $_SESSION['msg']="Package inserted successfully";
     }else{
  ...
  $insert=exeQuery("update ".TABLE_PACKAGE." set slug_name='".$slug."',price='".$price."',location='".$location."',description='".$description."',title='".$title."',status='".$status."',date='".$date."' $set where id='".$hid_id."' ");
...
{
  $id=$_REQUEST['id'];
  $qry_edit=exeQuery("select * from ".TABLE_PACKAGE." where id='".$id."'");
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                          <input type="text" id="first-title" class="form-control col-md-7 col-xs-12" name="title" value="<?php echo $res['title'];?>" placeholder="title">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                          <input type="text" id="first-title" class="form-control col-md-7 col-xs-12" name="slug" value="<?php echo $res['slug_name'];?>" placeholder="Slug">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-title">Price
                                        </label>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                          <input type="text" id="first-title" class="form-control col-md-7 col-xs-12" name="price" value="<?php echo $res['price'];?>" placeholder="Price">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-title">Location
                                        </label>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                          <input type="text" id="first-title" class="form-control col-md-7 col-xs-12" name="location" value="<?php echo $res['location'];?>" placeholder="Location">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-content">Description
                                    </label>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <div class="form-group">
                              ...
                              <?php echo ($res['image']!="" and file_exists("../upload/".$res['image']))?"<img  src='../upload/".$res['image']."' height='150px;'>":"<img class='img-responsive' src=''>";?>
                          </div>
                          <div class="form-group">
