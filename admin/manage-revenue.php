            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        <div class="card-header">Manage Member
                        </div>
                       <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <div class="widget-content-left">
                                                                   <?php echo ($res_user['uimage']!="" and file_exists("../upload/".$res_user['uimage']))?"<img  src='../upload/".$res_user['uimage']."'  class='rounded-circle' height='40px' >":"<img  src='assets/images/avatars/2.jpg'  class='rounded-circle' height='40px' >";?>
                                                                </div>
                                                ...
                                                <td class="text-center"><?php echo $res_user['title'];?></td>
                                                 <td class="text-center"><?php echo $res_user['paid_amount'];?></td>
